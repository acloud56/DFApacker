...
Write-Output $disks
New-Item -Path "L:\SQLLogs_Vol1" -ItemType Directory
New-Item -Path "X:\TempDB_Vol1" -ItemType Directory
New-Item -Path "R:\SQLData_Vol0" -ItemType Directory
New-Item -Path "R:\SQLData_Vol1" -ItemType Directory 
